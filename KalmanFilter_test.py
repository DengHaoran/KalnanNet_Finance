...
def KFTest(SysModel, test_input, test_target):
    ...
    for j in range(0, N_T):
        ...
        # MSE_KF_linear_arr[j] = loss_fn(KF.x, test_target).item()
    ...
    print("KF - MSE MEAN:", MSE_KF_dB_avg, "[dB]")
    print("KF - MSE STD:", MSE_KF_dB_std, "[dB]")
    # Print Run Time
    # print("Inference Time:", t)

    return [KF, MSE_KF_linear_arr, MSE_KF_linear_avg, MSE_KF_dB_avg]

...
class System_Model:
    ...
    ### Generate Sequence ###
    #########################
    def GenerateSequence(self, Q_gen, R_gen, T,  True_data = 0):
        if True_data==0:
    ...
    ### Generate Batch ###
    ######################
    def GenerateBatch(self, size, T, randomInit=False, seqInit=False, T_test=0, True_data = 0):
        ...
        for i in range(0, size):
            ...
            self.GenerateSequence(self.Q, self.R, T, True_data)
